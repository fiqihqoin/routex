-- CaishenEngine Final Database Schema
...
CREATE TABLE api_keys (
    ...
    key_prefix VARCHAR(20) NOT NULL,     -- 'caishenengine_sb_xxxx'
...
('PAKAILINK', 'PakaiLink', 'https://dev-api.pakaidonk.id', 'https://api.pakaidonk.id');
